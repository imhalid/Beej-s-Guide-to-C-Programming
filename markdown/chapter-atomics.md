...
## <span class="header-section-number">40.1</span> Testing for Atomic Support

Atomics are an optional feature. There’s a macro `__STDC_NO_ATOMICS__` that’s `1` if you *don’t* have atomics.

That macro might not exist pre-C11, so we should test the language version with `__STDC_VERSION__`<a href="function-specifiers-alignment-specifiersoperators.html#fn209" id="fnref209" class="footnote-ref" role="doc-noteref"><sup>209</sup></a>.
...
## <span class="header-section-number">40.2</span> Atomic Variables
...
It’s almost like there’s a little lock around the getting and setting of that one variable. (And there *might* be! See [Lock-Free Atomic Variables](chapter-atomics.html#lock-free-atomic), below.)
...
You might be wondering what happens if that’s a regular non-atomic `int`, instead. Well, on my system it still works… unless I do an optimized build in which case it hangs on thread 2 waiting to see the 3490 to get set<a href="function-specifiers-alignment-specifiersoperators.html#fn210" id="fnref210" class="footnote-ref" role="doc-noteref"><sup>210</sup></a>.
...
## <span class="header-section-number">40.3</span> Synchronization
...
Using atomic variables can force the agreement<a href="function-specifiers-alignment-specifiersoperators.html#fn211" id="fnref211" class="footnote-ref" role="doc-noteref"><sup>211</sup></a>. If a thread writes to an atomic variable, it’s saying “anyone who reads this atomic variable in the future will also see all the changes I made to memory (atomic or not) up to and including the atomic variable”.
...
## <span class="header-section-number">40.4</span> Acquire and Release
...
## <span class="header-section-number">40.5</span> Sequential Consistency
...
*Sequential consistency* is what’s called a *memory ordering*. There are many memory orderings, but sequential consistency is the sanest<a href="function-specifiers-alignment-specifiersoperators.html#fn212" id="fnref212" class="footnote-ref" role="doc-noteref"><sup>212</sup></a> C has to offer. It is also the default. You have to go out of your way to use other memory orderings.
...
## <span class="header-section-number">40.6</span> Atomic Assignments and Operators
...
## <span class="header-section-number">40.7</span> Library Functions that Automatically Synchronize
...
## <span class="header-section-number">40.8</span> Atomic Type Specifier, Qualifier
...
First, specifier! It’s the keyword `_Atomic` with a type in parens after<a href="function-specifiers-alignment-specifiersoperators.html#fn213" id="fnref213" class="footnote-ref" role="doc-noteref"><sup>213</sup></a>—suitable for use with `typedef`:
...
So these do similar things<a href="function-specifiers-alignment-specifiersoperators.html#fn214" id="fnref214" class="footnote-ref" role="doc-noteref"><sup>214</sup></a>:
...
## <span class="header-section-number">40.9</span> Lock-Free Atomic Variables
...
Wait—how can something be *sometimes* lock-free? This just means the answer isn’t known at compile-time, but could later be known at runtime. Maybe the answer varies depending on whether or not you’re running this code on Genuine Intel or AMD, or something like that<a href="function-specifiers-alignment-specifiersoperators.html#fn215" id="fnref215" class="footnote-ref" role="doc-noteref"><sup>215</sup></a>.
...
### <span class="header-section-number">40.9.1</span> Signal Handlers and Lock-Free Atomics
...
The spec is a bit vague, in my read, about the memory order when it comes to acquiring or releasing atomic variables in the signal handler. C++ says, and it makes sense, that such accesses are unsequenced with respect to the rest of the program<a href="function-specifiers-alignment-specifiersoperators.html#fn216" id="fnref216" class="footnote-ref" role="doc-noteref"><sup>216</sup></a>. The signal can be raised, after all, at any time. So I’m assuming C’s behavior is similar.

## <span class="header-section-number">40.10</span> Atomic Flags

There’s only one type the standard guarantees will be a lock-free atomic: `atomic_flag`. This is an opaque type for [test-and-set](https://en.wikipedia.org/wiki/Test-and-set)<a href="function-specifiers-alignment-specifiersoperators.html#fn217" id="fnref217" class="footnote-ref" role="doc-noteref"><sup>217</sup></a> operations.
...
## <span class="header-section-number">40.11</span> Atomic `struct`s and `union`s
...
## <span class="header-section-number">40.12</span> Atomic Pointers
...
## <span class="header-section-number">40.13</span> Memory Order
...
### <span class="header-section-number">40.13.1</span> Sequential Consistency
...
### <span class="header-section-number">40.13.2</span> Acquire
...
### <span class="header-section-number">40.13.3</span> Release
...
### <span class="header-section-number">40.13.4</span> Consume
...
### <span class="header-section-number">40.13.5</span> Acquire/Release
...
### <span class="header-section-number">40.13.6</span> Relaxed
...
## <span class="header-section-number">40.14</span> Fences
...
Since a consume operation doesn’t really make sense on a fence<a href="function-specifiers-alignment-specifiersoperators.html#fn218" id="fnref218" class="footnote-ref" role="doc-noteref"><sup>218</sup></a>, `memory_order_consume` is treated as an acquire.
...
## <span class="header-section-number">40.15</span> References
...
- Herb Sutter’s *`atomic<>` Weapons* talk:
  ...
  - [Part 1](https://www.youtube.com/watch?v=A8eCGOqgvH4)<a href="function-specifiers-alignment-specifiersoperators.html#fn219" id="fnref219" class="footnote-ref" role="doc-noteref"><sup>219</sup></a>
  - [part 2](https://www.youtube.com/watch?v=KeLBd2EJLOU)<a href="function-specifiers-alignment-specifiersoperators.html#fn220" id="fnref220" class="footnote-ref" role="doc-noteref"><sup>220</sup></a>

- [Jeff Preshing’s materials](https://preshing.com/archives/)<a href="function-specifiers-alignment-specifiersoperators.html#fn221" id="fnref221" class="footnote-ref" role="doc-noteref"><sup>221</sup></a>, in particular:

  - [An Introduction to Lock-Free Programming](https://preshing.com/20120612/an-introduction-to-lock-free-programming/)<a href="function-specifiers-alignment-specifiersoperators.html#fn222" id="fnref222" class="footnote-ref" role="doc-noteref"><sup>222</sup></a>
  - [Acquire and Release Semantics](https://preshing.com/20120913/acquire-and-release-semantics/)<a href="function-specifiers-alignment-specifiersoperators.html#fn223" id="fnref223" class="footnote-ref" role="doc-noteref"><sup>223</sup></a>
  - [The *Happens-Before* Relation](https://preshing.com/20130702/the-happens-before-relation/)<a href="function-specifiers-alignment-specifiersoperators.html#fn224" id="fnref224" class="footnote-ref" role="doc-noteref"><sup>224</sup></a>
  - [The *Synchronizes-With* Relation](https://preshing.com/20130823/the-synchronizes-with-relation/)<a href="function-specifiers-alignment-specifiersoperators.html#fn225" id="fnref225" class="footnote-ref" role="doc-noteref"><sup>225</sup></a>
  - [The Purpose of `memory_order_consume` in C++11](https://preshing.com/20140709/the-purpose-of-memory_order_consume-in-cpp11/)<a href="function-specifiers-alignment-specifiersoperators.html#fn226" id="fnref226" class="footnote-ref" role="doc-noteref"><sup>226</sup></a>
  - [You Can Do Any Kind of Atomic Read-Modify-Write Operation](https://preshing.com/20150402/you-can-do-any-kind-of-atomic-read-modify-write-operation/)<a href="function-specifiers-alignment-specifiersoperators.html#fn227" id="fnref227" class="footnote-ref" role="doc-noteref"><sup>227</sup></a>

- CPPReference:

  - [Memory Order](https://en.cppreference.com/w/c/atomic/memory_order)<a href="function-specifiers-alignment-specifiersoperators.html#fn228" id="fnref228" class="footnote-ref" role="doc-noteref"><sup>228</sup></a>
  - [Atomic Types](https://en.cppreference.com/w/c/language/atomic)<a href="function-specifiers-alignment-specifiersoperators.html#fn229" id="fnref229" class="footnote-ref" role="doc-noteref"><sup>229</sup></a>

- Bruce Dawson’s [Lockless Programming Considerations](https://docs.microsoft.com/en-us/windows/win32/dxtecharts/lockless-programming)<a href="function-specifiers-alignment-specifiersoperators.html#fn230" id="fnref230" class="footnote-ref" role="doc-noteref"><sup>230</sup></a>

- The helpful and knowledgeable folks on [r/C_Programming](https://www.reddit.com/r/C_Programming/)<a href="function-specifiers-alignment-specifiersoperators.html#fn231" id="fnref231" class="footnote-ref" role="doc-noteref"><sup>231</sup></a>
