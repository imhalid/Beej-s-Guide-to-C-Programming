...
## <span class="header-section-number">33.1</span> Type Qualifiers for Arrays in Parameter Lists
...
## <span class="header-section-number">33.2</span> `static` for Arrays in Parameter Lists
...
## <span class="header-section-number">33.3</span> Equivalent Initializers
