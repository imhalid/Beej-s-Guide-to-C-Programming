...
## <span class="header-section-number">34.1</span> Using `setjmp` and `longjmp`
...
## <span class="header-section-number">34.2</span> Pitfalls

Under the hood, this is pretty straightforward. Typically the *stack pointer* keeps track of the locations in memory that local variables are stored, and the *program counter* keeps track of the address of the currently-executing instruction<a href="function-specifiers-alignment-specifiersoperators.html#fn181" id="fnref181" class="footnote-ref" role="doc-noteref"><sup>181</sup></a>.
...
### <span class="header-section-number">34.2.1</span> The Values of Local Variables
...
Technically, they only have to be `volatile` if they change between the time `setjmp()` is called and `longjmp()` is called<a href="function-specifiers-alignment-specifiersoperators.html#fn182" id="fnref182" class="footnote-ref" role="doc-noteref"><sup>182</sup></a>.
...
### <span class="header-section-number">34.2.2</span> How Much State is Saved?
...
### <span class="header-section-number">34.2.3</span> You Can’t Name Anything `setjmp`
...
### <span class="header-section-number">34.2.4</span> You Can’t `setjmp()` in a Larger Expression
...
### <span class="header-section-number">34.2.5</span> When Can’t You `longjmp()`?
...
### <span class="header-section-number">34.2.6</span> You Can’t Pass `0` to `longjmp()`
...
### <span class="header-section-number">34.2.7</span> `longjmp()` and Variable Length Arrays

If you are in scope of a VLA and `longjmp()` out there, the memory allocated to the VLA could leak<a href="function-specifiers-alignment-specifiersoperators.html#fn183" id="fnref183" class="footnote-ref" role="doc-noteref"><sup>183</sup></a>.
