...
## <span class="header-section-number">30.1</span> The Basics
...
- You can’t declare a VLA at file scope, and you can’t make a `static` one in block scope<a href="function-specifiers-alignment-specifiersoperators.html#fn175" id="fnref175" class="footnote-ref" role="doc-noteref"><sup>175</sup></a>.
...
## <span class="header-section-number">30.2</span> `sizeof` and VLAs
...
## <span class="header-section-number">30.3</span> Multidimensional VLAs
...
## <span class="header-section-number">30.4</span> Passing One-Dimensional VLAs to Functions
...
## <span class="header-section-number">30.5</span> Passing Multi-Dimensional VLAs to Functions
...
### <span class="header-section-number">30.5.1</span> Partial Multidimensional VLAs
...
## <span class="header-section-number">30.6</span> Compatibility with Regular Arrays
...
For example, if we have a function that specifically wants a <span class="math inline">\\3\times5\\</span> array, we can still pass a VLA into it.
...
## <span class="header-section-number">30.7</span> `typedef` and VLAs
...
## <span class="header-section-number">30.8</span> Jumping Pitfalls
...
## <span class="header-section-number">30.9</span> General Issues
