...
## <span class="header-section-number">4.1</span> Passing by Value
...
## <span class="header-section-number">4.2</span> Function Prototypes
...
## <span class="header-section-number">4.3</span> Empty Parameter Lists

You might see these from time to time in older code, but you shouldn’t ever code one up in new code. Always use `void` to indicate that a function takes no parameters. There’s never<a href="function-specifiers-alignment-specifiersoperators.html#fn44" id="fnref44" class="footnote-ref" role="doc-noteref"><sup>44</sup></a> a reason to skip this in modern code.
