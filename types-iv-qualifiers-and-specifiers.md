...
#### <span class="header-section-number">16.1.1.1</span> `const` and Pointers
...
#### <span class="header-section-number">16.1.1.2</span> `const` Correctness
...
### <span class="header-section-number">16.1.2</span> `restrict`
...
### <span class="header-section-number">16.1.3</span> `volatile`
...
### <span class="header-section-number">16.1.4</span> `_Atomic`

This is an optional C feature that we’ll talk about in [the Atomics chapter](chapter-atomics.html#chapter-atomics).

## <span class="header-section-number">16.2</span> Storage-Class Specifiers
...
### <span class="header-section-number">16.2.1</span> `auto`
...
### <span class="header-section-number">16.2.2</span> `static`

This keyword has two meanings, depending on if the variable is file scope or block scope.

Let’s start with block scope.

#### <span class="header-section-number">16.2.2.1</span> `static` in Block Scope
...
#### <span class="header-section-number">16.2.2.2</span> `static` in File Scope
...
### <span class="header-section-number">16.2.3</span> `extern`
...
### <span class="header-section-number">16.2.4</span> `register`
...
### <span class="header-section-number">16.2.5</span> `_Thread_local`
