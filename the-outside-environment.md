...
## <span class="header-section-number">18.1</span> Command Line Arguments
...
In this case, the command is `ls`, but its arguments are all files that end with `.txt`<a href="function-specifiers-alignment-specifiersoperators.html#fn120" id="fnref120" class="footnote-ref" role="doc-noteref"><sup>120</sup></a>.
...
Whoa! What’s going on with the `main()` function signature? What’s `argc` and `argv`<a href="function-specifiers-alignment-specifiersoperators.html#fn121" id="fnref121" class="footnote-ref" role="doc-noteref"><sup>121</sup></a> (pronounced *arg-cee* and *arg-vee*)?
...
### <span class="header-section-number">18.1.1</span> The Last `argv` is `NULL`
...
### <span class="header-section-number">18.1.2</span> The Alternate: `char **argv`
...
### <span class="header-section-number">18.1.3</span> Fun Facts
...
- On some Unix-like systems, modifying the string `argv[0]` results in the output of `ps` changing<a href="function-specifiers-alignment-specifiersoperators.html#fn122" id="fnref122" class="footnote-ref" role="doc-noteref"><sup>122</sup></a>.
...
## <span class="header-section-number">18.2</span> Exit Status
...
Let’s get [Inception](https://en.wikipedia.org/wiki/Inception)<a href="function-specifiers-alignment-specifiersoperators.html#fn123" id="fnref123" class="footnote-ref" role="doc-noteref"><sup>123</sup></a> for a second: turns out that when you run your program, *you’re running it from another program*.

Usually this other program is some kind of [shell](https://en.wikipedia.org/wiki/Shell_(computing))<a href="function-specifiers-alignment-specifiersoperators.html#fn124" id="fnref124" class="footnote-ref" role="doc-noteref"><sup>124</sup></a> that doesn’t do much on its own except launch other programs.
...
But that doesn’t really show the exit status that we returned, does it? We can get the shell to print it out, though. Assuming you’re running Bash or another POSIX shell, you can use `echo $?` to see it<a href="function-specifiers-alignment-specifiersoperators.html#fn125" id="fnref125" class="footnote-ref" role="doc-noteref"><sup>125</sup></a>.
...
### <span class="header-section-number">18.2.1</span> Other Exit Status Values
...
## <span class="header-section-number">18.3</span> Environment Variables
...
Notice they are in the form of key/value pairs. For example, one key is `HOSTTYPE` and its value is `x86_64`. From a C perspective, all values are strings, even if they’re numbers<a href="function-specifiers-alignment-specifiersoperators.html#fn126" id="fnref126" class="footnote-ref" role="doc-noteref"><sup>126</sup></a>.
...
In bash, I can set it to something with<a href="function-specifiers-alignment-specifiersoperators.html#fn127" id="fnref127" class="footnote-ref" role="doc-noteref"><sup>127</sup></a>:
...
### <span class="header-section-number">18.3.1</span> Setting Environment Variables
...
### <span class="header-section-number">18.3.2</span> Unix-like Alternative Environment Variables
...
Another non-standard way to get the environment variables is as a parameter to `main()`. It works much the same way, but you avoid needing to add your `extern` `environ` variable. [Not even the POSIX spec supports this](https://pubs.opengroup.org/onlinepubs/9699919799/functions/exec.html)<a href="function-specifiers-alignment-specifiersoperators.html#fn128" id="fnref128" class="footnote-ref" role="doc-noteref"><sup>128</sup></a> as far as I can tell, but it’s common in Unix land.
