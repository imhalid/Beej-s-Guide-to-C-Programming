...
## <span class="header-section-number">25.1</span> Ellipses in Function Signatures
...
## <span class="header-section-number">25.2</span> Getting the Extra Arguments
...
## <span class="header-section-number">25.3</span> `va_list` Functionality

What is that `va_list` variable we’re using up there? It’s an opaque variable<a href="function-specifiers-alignment-specifiersoperators.html#fn154" id="fnref154" class="footnote-ref" role="doc-noteref"><sup>154</sup></a> that holds information about which argument we’re going to get next with `va_arg()`. You see how we just call `va_arg()` over and over? The `va_list` variable is a placeholder that’s keeping track of progress so far.
...
And that’s *why* we need to have at least one named variable in our argument list<a href="function-specifiers-alignment-specifiersoperators.html#fn155" id="fnref155" class="footnote-ref" role="doc-noteref"><sup>155</sup></a>.
...
## <span class="header-section-number">25.4</span> Library Functions That Use `va_list`s
...
## <span class="header-section-number">25.5</span> Variadic Macro Gotchas
